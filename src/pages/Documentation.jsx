            ...
            <div className="prose prose-invert max-w-none">
              ...
              <section className="scroll-mt-20 mb-12">
                ...
                <ol className="list-decimal list-inside space-y-2 text-[#666] text-base ml-4">
                  ...
                  <li>Aguarde a aprovação do pedido (até 30 minutos)</li>
              ...
              <section id="security" className="scroll-mt-20 mb-12">
                ...
                <p className="text-[#666] leading-relaxed text-base mb-3">
                  A segurança dos seus dados é nossa prioridade. Utilizamos criptografia SSL em todas as páginas.
                </p>
                <p className="text-[#666] leading-relaxed text-base">
                  Pagamentos são processados via PIX, garantindo segurança e agilidade nas transações.
                </p>
              </section>
              ...
              <section id="support" className="scroll-mt-20 mb-12">
                ...
                <p className="text-[#666] leading-relaxed text-base">
                  Entre em contato pelo Discord ou e-mail: <strong className="text-white">suporte@marketplace.com</strong>
                </p>
              </section>
