...
import { ArrowLeft, Upload, Loader2, Instagram, Github, Linkedin, Twitter, Globe, MapPin, Info, User, Image as ImageIcon, Save, Image } from 'lucide-react';
      ...
      <div className="flex-1 max-w-3xl mx-auto w-full px-4 py-8">
        ...
        <div className="space-y-8">
          ...
          <div className="border-b border-[#1A1A1A] pb-4">
            <h2 className="text-xl font-bold text-white mb-2">Informações da Loja</h2>
            <p className="text-xs text-[#555]">Dados básicos para identificação da sua loja</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Ex: Sou desenvolvedor há 5 anos, especializado em sistemas para Unity..."
              />
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-[#555] mb-2">
                Compartilhe seu portfólio ou site pessoal.
              </p>
              <input
                type="url"
                value={form.website}
          ...
          <div className="border-b border-[#1A1A1A] pb-4 pt-4">
            <h2 className="text-xl font-bold text-white mb-2">Mídia</h2>
            <p className="text-xs text-[#555]">Imagens que representam sua loja</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-[#555] mb-2">
                Sua logo ou foto de perfil. Tamanho recomendado: 400x400 pixels.
              </p>
              <div className="flex items-center gap-6">
                <div className="w-20 h-20 rounded-full bg-[#1A1A1A] overflow-hidden border border-[#333]">
                  {form.avatar_url ? (
            ...
            <div>
              ...
              <p className="text-xs text-[#555] mb-2">
                Imagem de capa da sua loja. Tamanho recomendado: 1200x300 pixels.
              </p>
              <div className="space-y-3">
                <div className="h-32 bg-[#1A1A1A] rounded-lg overflow-hidden border border-[#1A1A1A]">
                  {form.banner_url ? (
          ...
          <div className="border-b border-[#1A1A1A] pb-4 pt-4">
            ...
            <p className="text-xs text-[#555]">Onde seus clientes podem te encontrar</p>
          </div>
