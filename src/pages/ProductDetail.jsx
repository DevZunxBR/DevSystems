// src/pages/ProductDetail.jsx - Versão completa
              ...
              <div className="space-y-2">
                {isClosed ? (
                  ...
                  <>
                    ...
                    {/* Botão de presente - estilizado igual ao site */}
                    <Button
                      onClick={() => setShowGiftModal(true)}
                      variant="outline"
                      className="w-full border-pink-500/30 text-pink-400 hover:bg-pink-500/10 hover:border-pink-500/50 gap-2 h-11 rounded-xl"
                    >
