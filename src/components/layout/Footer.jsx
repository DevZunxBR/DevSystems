      ...
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-14">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-10">
          <div className="space-y-4">
            ...
            <p className="text-xs text-[#555] leading-relaxed max-w-[230px]">
            ...
            <div className="flex items-center gap-3 pt-1">
              {SOCIAL_LINKS.map(({ label, href, Icon }) => (
                <a
                  ...
                  aria-label={label}
                  className="p-2 bg-[#0A0A0A] border border-[#1A1A1A] rounded-lg text-[#555] hover:text-white hover:border-[#333] transition-all"
                >
                  <Icon />
                </a>
              ))}
